  	...
  	$(function(){
  		$("#dg").datagrid({
			...
			toolbar: [{
				...
				text:'添加',
				handler: function(){
					createwindow("添加", "projectController.do?goadd",400,300);
					}
			},{
				iconCls: 'icon-edit',
				text:'编辑',
			...
			},
			{
				...
				text:'导入',
				handler: function(){
					createwindow("导入", "projectController.do?impgo",400,300);
				}
			},
			{
				iconCls: 'icon-edit',
 			 ...
 			 columns:[[
					{field : 'IDs',title : 'IDs',checkbox : true,width : 8,align : 'center'}, 
 			         ...
 			         {field:'NUM',title:'数量/吨',width:100,align:'center'},   
  		...
  		$.ajax({
  			...
  			success:function(msg){
  				...
  				$('#dg').datagrid({data:{"total":map.length,"rows":map,
  					"footer":[{"NUM":"总量","BAlANCE1":"总计","obj":"ss"},
  				              {"NUM":num.split(",")[1]+"吨","BAlANCE1":num.split(",")[0],"obj":"ss"}]}}).datagrid('clientPaging');
